# Django settings for indivo_admin project.
import os
...
ADMINS = tuple([user[:2] for user in DEFAULT_USERS])
MANAGERS = ADMINS
...
SECRET_KEY = '24bb0t5enx*%q8oor%&ig%^q8vl@ot+-6(9)(1yc@xvr-cr$(!'
...
ROOT_URLCONF = 'indivo_admin.urls'
...
SESSION_COOKIE_NAME = "indivo_admin_sessionid"
